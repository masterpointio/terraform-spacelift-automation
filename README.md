...
| <a name="input_aws_integration_id"></a> [aws\_integration\_id](#input\_aws\_integration\_id) | ID of the AWS integration to attach for both read and write (single-integration shape). Mutually exclusive with aws\_integration\_read\_id / aws\_integration\_write\_id. | `string` | `null` | no |
| <a name="input_aws_integration_name"></a> [aws\_integration\_name](#input\_aws\_integration\_name) | Name of the AWS integration to attach for both read and write (single-integration shape), resolved to an ID. Mutually exclusive with aws\_integration\_id and with the per-side vars. | `string` | `null` | no |
| <a name="input_aws_integration_read_id"></a> [aws\_integration\_read\_id](#input\_aws\_integration\_read\_id) | ID of the AWS integration for the read attachment (split-integration shape). Must be set together with aws\_integration\_write\_id. Mutually exclusive with aws\_integration\_id / aws\_integration\_name. | `string` | `null` | no |
| <a name="input_aws_integration_read_name"></a> [aws\_integration\_read\_name](#input\_aws\_integration\_read\_name) | Name of the AWS integration for the read attachment, resolved to an ID. Mutually exclusive with aws\_integration\_read\_id. | `string` | `null` | no |
| <a name="input_aws_integration_write_id"></a> [aws\_integration\_write\_id](#input\_aws\_integration\_write\_id) | ID of the AWS integration for the write attachment (split-integration shape). Must be set together with aws\_integration\_read\_id. Mutually exclusive with aws\_integration\_id / aws\_integration\_name. | `string` | `null` | no |
| <a name="input_aws_integration_write_name"></a> [aws\_integration\_write\_name](#input\_aws\_integration\_write\_name) | Name of the AWS integration for the write attachment, resolved to an ID. Mutually exclusive with aws\_integration\_write\_id. | `string` | `null` | no |

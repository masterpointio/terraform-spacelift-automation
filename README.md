...
| <a name="input_autoretry"></a> [autoretry](#input\_autoretry) | Flag to enable/disable automatic retry of the stack. Only supported with private worker pools; on public workers use a Trigger policy. Docs: https://docs.spacelift.io/concepts/stack/stack-settings#autoretry | `bool` | `false` | no |
